...
// Allow requests from the native app shell (Capacitor serves the app from
// capacitor://localhost on iOS and https://localhost on Android, not from
// this server's own origin) and from any web deployment of the frontend.
